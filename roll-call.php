        ...
        <div class="col-lg-12">
            <div class="card border-0 shadow">
                <div class="card-header">
                    <form id="student_roll_call_dtfrm" role="form">
                        <fieldset form="student_roll_call_dtfrm">
                            ...
                            <div class="form-row align-items-md-center align-items-lg-center">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="roll_call_date">Date</label>
                                    <input type="text" name="roll_call_date" id="roll_call_date" class="form-control" value="<?php echo date('d M, Y') ?>" readonly>
                                </div>
                                <div class="form-group col-md-2">
                                    <label for="roll_call_loadbtn" class="mb-5"></label>
                                    <button type="submit" class="btn btn-primary" id="roll_call_loadbtn">Load</button>
                                </div>
                            </div>
                        </fieldset>
                    </form>
                ...
                <div class="card-body">
                    ...
                    <span id="load_student_roll_call"></span>
                </div>
            </div>
        </div>
    </div>
