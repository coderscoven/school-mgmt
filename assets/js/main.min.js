...
!(function ($) {
    ...
    $('#new_course').click(function () {
        uni_modal("New Class and Fees Entry", "manage_course.php", 'large')

    })

    $('.edit_course').click(function () {
        uni_modal("Manage Classes and Fees Entry", "manage_course.php?id=" + $(this).attr('data-id'), 'large')

    })
    $('.delete_course').click(function () {
        _conf("Are you sure to delete this Class?", "delete_course", [$(this).attr('data-id')])
    })
